                    ...
                    <section>
                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                                ...
                                <p>By uploading images or audio files, or by streaming live audio into the Service, you represent and warrant that you own or have the necessary rights, licenses, consents, and permissions to use and authorize us to process such content. You retain full ownership of your uploaded content and any visualizer videos generated by the Service. By using the Service, you grant Muxels a temporary, limited license to process your content locally in your browser solely to provide the requested visual effects. You are explicitly responsible for ensuring your use of any content (including streaming copyrighted material) complies with third-party copyrights (e.g., music licensing, public performance rights). Muxels does not allow exporting video files while in live-audio mode to help prevent unauthorized distribution and protect the rights of content creators and musicians.</p>
                            </div>
