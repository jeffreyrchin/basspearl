            ...
            >
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-8 text-white/80 text-sm leading-relaxed custom-scrollbar">
                    <section>
                        ...
                        <p className="text-white/60 mb-6 text-xs">Last Updated: May 13, 2026</p>

                        <div className="space-y-6">
                            <div>
                                <h3 className="text-white font-bold uppercase tracking-widest mb-2 text-xs">1. Introduction</h3>
                                <p>Welcome to basspearl. We respect your privacy and are committed to protecting your personal data. This privacy policy will inform you as to how we look after your personal data when you visit our website and tell you about your privacy rights and how the law protects you.</p>
                            </div>
                            ...
                            <div>
                                ...
                                <ul className="list-disc pl-5 mt-2 space-y-1 text-white/60">
                                    ...
                                    <li><strong>Real-Time Audio (Microphone & Tab Audio):</strong> If you grant microphone permission or choose to share tab audio, we process live audio streams locally in your browser to drive real-time visuals. This data is processed in volatile memory (RAM), is never recorded, and never leaves your device.</li>
                                </ul>
                            </div>
                    ...
                    <section>
                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                                ...
                                <p>By accessing or using the basspearl website and services, you agree to be bound by these Terms. If you disagree with any part of the terms then you may not access the Service.</p>
                            </div>

                            <div>
                                <h3 className="text-white font-bold uppercase tracking-widest mb-2 text-xs">2. Description of Service</h3>
                                <p>basspearl provides a web-based graphics engine for generating audio-reactive visualizers and applying visual effects to user-uploaded images. The service allows for real-time reactivity using both uploaded files and live audio inputs (e.g., microphone, virtual audio drivers, or browser-tab audio capture), as well as hardware-accelerated export of MP4 video files (when not in live mode). You are responsible for ensuring you have the right to use any audio processed through the service. All processing occurs client-side within your browser - no media files are uploaded to our servers.</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p>By uploading images or audio files, or by streaming live audio into the Service, you represent and warrant that you own or have the necessary rights, licenses, consents, and permissions to use and authorize us to process such content. You retain full ownership of your uploaded content and any visualizer videos generated by the Service. By using the Service, you grant basspearl a temporary, limited license to process your content locally in your browser solely to provide the requested visual effects. You are explicitly responsible for ensuring your use of any content (including streaming copyrighted material) complies with third-party copyrights (e.g., music licensing, public performance rights). basspearl does not allow exporting video files while in live-audio mode to help prevent unauthorized distribution and protect the rights of content creators and musicians.</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p>The Service and its original content (excluding Content provided by users), features and functionality are and will remain the exclusive property of basspearl and its licensors.</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p>The Service may use third-party services (such as Firebase and Lemon Squeezy) that declare their own Terms of Service. By using the Service, you acknowledge and agree that basspearl is not responsible for the availability of such external sites or resources.</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p>In no event shall basspearl, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses. In no event shall basspearl's total liability to you for all damages, losses, and causes of action exceed the amount you have paid basspearl in the last six (6) months, or, if greater, one hundred dollars ($100).</p>
                            </div>

                            <div>
                                <h3 className="text-white font-bold uppercase tracking-widest mb-2 text-xs">12. Indemnification</h3>
                                <p>You agree to defend, indemnify and hold harmless basspearl and its licensee and licensors, and their employees, contractors, agents, officers and directors, from and against any and all claims, damages, obligations, losses, liabilities, costs or debt, and expenses.</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p>If you have any concern or dispute about the Service, you agree to first try to resolve the dispute informally by contacting basspearl.</p>
                            </div>

                            <div>
                                <h3 className="text-white font-bold uppercase tracking-widest mb-2 text-xs">16. Arbitration Agreement</h3>
                                <p>For any dispute you have with basspearl, you agree to first simply contact us and attempt to resolve the dispute with us informally. If basspearl has not been able to resolve the dispute with you informally, we each agree to resolve any claim, dispute, or controversy via binding arbitration.</p>
                                <p className="mt-2 text-white/60 text-xs bg-white/5 p-3 rounded">
