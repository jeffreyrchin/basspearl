...
const LandingModal: React.FC<LandingModalProps> = ({ isOpen, onStart, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-modal flex items-center justify-center p-4">
            ...
            <div data-section="modal" className="relative w-full max-w-sm bg-slate-700 rounded-2xl border border-white/20 max-h-[90vh] overflow-y-auto custom-scrollbar animate-in fade-in zoom-in-95 duration-300 flex flex-col items-center">
                {/* Close Button */}
                <button
                    onClick={onClose}
