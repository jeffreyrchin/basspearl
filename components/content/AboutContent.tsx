        ...
        <div className="max-w-4xl mx-auto space-y-12">
            ...
            <section className="space-y-4">
                ...
                <p className="text-white/90 text-base md:text-lg leading-relaxed">
                    basspearl is an AI-powered visual synthesizer that combines visual effects and audio to create audio-reactive visualizers. Your creations can be exported as MP4 files to share or use in any of your creative projects.
                </p>
            </section>
