...
export const EFFECT_METADATA: Record<GlitchEffectType, EffectMetadata> = {
  ...
  DATA_CORRUPTION: {
    ...
    category: 'Modifier',
    params: [
      p('Displacement', { v: 20 }, { v: 70, b: 'SUB' }),
      p('Mosh Level', { v: 100 }, { v: 40, b: 'SUB' }),
    ],
  },
  DEEP_FRY: {
    label: 'Color Burn',
  ...
  TERRAIN_SPHERE: {
    label: 'Ball Transform',
    category: 'Modifier',
    params: [
      p('Extrusion', { v: 10 }),
      p('Detail Level', { v: 100 }),
      p('Size', { v: 50 }, { v: 45 }),
      p('Offset X', { v: 0 }, { v: 25 }, true),
      p('Offset Y', { v: 0 }, { v: 25 }, true),
      p('Offset Z', { v: 25 }, undefined, true),
      p('Spin Speed X', { v: 25 }),
      p('Spin Speed Y', { v: 0 }, { v: 25 }),
      p('Spin Speed Z', { v: 0 }),
      p('Seam Blend', { v: 0 }, { v: 50 }),
    ],
  },
  TERRAIN_RING: {
    label: 'Ring Warp',
    ...
    params: [
      ...
      p('Spin Speed Y', { v: 0 }),
      p('Spin Speed Z', { v: 0 }),
      p('Tube Width', { v: 30 }, { v: 40 }),
      p('Seam Blend', { v: 0 }, { v: 25 }),
    ],
  },
  CHECKERBOARD: {
    label: 'Checkerboard',
