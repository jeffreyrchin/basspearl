 ...
 * These shaders take two inputs: u_image (from) and u_to_image (to),
...
export const TRANSITION_SHADERS = {
    ...
    void main() {
        ...
        vec4 to = texture(u_to_image, v_texCoord);
    ...
    void main() {
        ...
        vec4 to = texture(u_to_image, uvTo);
