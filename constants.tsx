...
export const EFFECT_METADATA: Record<GlitchEffectType, {
  ...
  GRAIN: { label: 'Grain', subLabel: 'GRAIN', icon: 'blur_on', category: 'Additive', paramNames: [{ name: 'Width' }, { name: 'Height' }, { name: 'X-Freq' }, { name: 'Y-Freq' }, { name: 'Density' }, { name: 'Roundness' }, { name: 'Blend' }] },
  SHAPE: { label: 'Shape', subLabel: 'SHAPE', icon: 'category', category: 'Additive', paramNames: [{ name: 'Side Count' }, { name: 'Pointiness' }, { name: 'Roundness' }, { name: 'Size' }, { name: 'Feather' }, { name: 'Blend' }] },
...
export const INITIAL_REACTIVE_EFFECTS: EffectConfig[] = buildEffects([
  ...
  { type: 'GRAIN', values: [100, 100, 50, 50, 100, 0, 100], reactive: false, frequencyBand: 'TREBLE' },
  ...
  { type: 'SHAPE', values: [3, 0, 0, 30, 0, 100], reactive: false, frequencyBand: 'MID' },
